...
The **Create a CV** activity was a vital step in preparing for real-world job applications. It taught me how to structure and present my skills, education, and experiences in a professional format that employers expect. This task emphasized the importance of a well-organized, concise, and tailored CV for improving my chances in the job market. A strong CV is not just a summary of qualifications—it's a marketing document that showcases who I am, what I bring to the table, and why I'm a strong candidate.


### ✨ Reflection (STAR Technique)

- **Situation:** As part of the Work Readiness Training, I was assigned to complete a module on creating a professional CV that accurately reflects my background and competencies.
  
- **Task:** My task was to review the provided guidelines, understand the structure of a strong CV, and complete the online quiz that tested my knowledge on CV formatting and best practices.
  
- **Action:** I went through the instructional materials, noting the distinctions between different CV sections such as personal details, education, work experience, achievements, and references. I ensured that I understood how to tailor each section for a specific job role.
...
- Learned how to tailor a CV for specific roles.
...
The **CV Submission** activity was a crucial follow-up to the CV creation module. It involved submitting a polished and professional version of my curriculum vitae for evaluation. This task mirrors real-world scenarios where CVs are submitted for job or internship applications, providing an authentic experience in personal branding and presentation.

Although I have submitted my CV, I have not yet received feedback. I am confident that the document reflects the knowledge gained from the training and meets the standards of a professional CV.


### ✨ Reflection (STAR Technique)

- **Situation:** Following the CV creation module, I was required to formally submit my CV through the designated platform.
  
- **Task:** The objective was to prepare a complete and professional CV, formatted correctly and aligned with career goals, and submit it on time for review.
  
- **Action:** I took time to revise the content, ensuring all sections were clear and aligned with the feedback from the previous learning. I paid special attention to formatting, grammar, and keyword optimization relevant to my career in ICT: Application Development.
...
- Reinforced the importance of attention to detail and professionalism.
